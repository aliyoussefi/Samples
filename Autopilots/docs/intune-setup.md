...
| **Throwaway demo/test VM, not Intune-managed** | The optional Bicep kit can set the equivalent local registry value + a self-heal task instead — see [`../optional-test-vm/README.md`](../optional-test-vm/README.md). |
