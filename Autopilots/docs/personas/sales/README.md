...
| Sample | Link |
|---|---|
| Heartbeat | [Seller heartbeat visual](seller/heartbeat.html) |
| Prompt | [Seller markdown prompt](seller/heartbeat.md) |
| Automation visual | [Seller automation visual](seller/automations.html) |
| Automation folder | [Seller automation markdown files](seller/automations/) |
| JSON folder | [Seller automation JSON files](seller/automations/json/) |
...
| Sample | Link |
|---|---|
| Heartbeat | [Sales manager heartbeat visual](sales-manager/heartbeat.html) |
| Prompt | [Sales manager markdown prompt](sales-manager/heartbeat.md) |
...
| Sample | Link |
|---|---|
| Heartbeat | [Account executive heartbeat visual](account-executive/heartbeat.html) |
| Prompt | [Account executive markdown prompt](account-executive/heartbeat.md) |
...
Add persona-local automation files later when a role needs a bounded scheduled workflow, such as a weekly pipeline prep brief, a daily customer response queue, or a monthly account-plan refresh.
