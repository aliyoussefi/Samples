...
| Sample | Link |
|---|---|
| Heartbeat | [Commercial contracts counsel heartbeat visual](commercial-contracts-counsel/heartbeat.html) |
| Prompt | [Commercial contracts counsel markdown prompt](commercial-contracts-counsel/heartbeat.md) |
| Automation | [Daily contract risk and response queue](commercial-contracts-counsel/automation.md) |
...
| Sample | Link |
|---|---|
| Heartbeat | [Legal operations manager heartbeat visual](legal-operations-manager/heartbeat.html) |
| Prompt | [Legal operations manager markdown prompt](legal-operations-manager/heartbeat.md) |
| Automation | [Weekly legal operations command brief](legal-operations-manager/automation.md) |
